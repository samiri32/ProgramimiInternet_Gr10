    ...
    <div class="gridat">
        ...
        <div class="usage">
            <div class="lajmet">
                ...
                <div class="gridi1">
                    <div class="ardy">
                        <img class="fototmodal" src="../../../public/img/HIVZIABABOOO.jpg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/HIVZIABABOOO.jpg">
                            <p class="tekstimodal">
                ...
                <div class="gridi2">
                    <div class="ardy">
                        <img style="float: right" class="fototmodal" src="../../../public/img/ismail-kadare-j-foley-opale-w-1-990x556.jpg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/ismail-kadare-j-foley-opale-w-1-990x556.jpg">
                            <p class="tekstimodal">
                ...
                <div class="gridi3">
                    <div class="ardy">
                        <img class="fototmodal" src="../../../public/img/ekspozita.jpeg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/ekspozita.jpeg">
                ...
                <div class="gridi4">
                    <div class="ardy">
                        <img style="float: right" class="fototmodal" src="../../../public/img/noli.jpg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/noli.jpg">
                ...
                <div class="gridi5">
                    <div class="ardy">
                        <img class="fototmodal" src="../../../public/img/mini-biblioteka.jpg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/mini-biblioteka.jpg">
                ...
                <div class="gridi6">
                    <div class="ardy">
                        <img style="float: right" class="fototmodal" src="../../../public/img/arsimimi.png">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/arsimimi.png">
                ...
                <div class="gridi7">
                    <div class="ardy">
                        <img class="fototmodal" src="../../../public/img/Dukagjinn-640x480.jpg">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/Dukagjinn-640x480.jpg">
                ...
                <div class="gridi8">
                    <div class="ardy">
                        <img style="float: right" class="fototmodal" src="../../../public/img/dhurohenlibra.png">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/dhurohenlibra.png">
                ...
                <div class="gridi10">
                    <div class="ardy">
                        <img class="fototmodal" src="../../../public/img/Aktiviteti.png">
                        <div class="modal">
                            <span class="close">×</span>
                            <img class="modal-content" src="../../../public/img/Aktiviteti.png">
